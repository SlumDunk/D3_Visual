 ...
 */
!function (t, e) {
    if ("object" == typeof exports && "object" == typeof module) module.exports = e(require("d3"), require("d3.chart")); else if ("function" == typeof define && define.amd) define(["d3", "d3.chart"], e); else {
    ...
    return function (t) {
        ...
        t.exports = i.extend("Sankey", {
            initialize: function () {
                ...
                var e = this, n = r.nest().key(function (t) {
                    return t.x
                ...
                n.forEach(function (t) {
                    var n, s, i = r.sum(t, function (t) {
                        return t.dy
                    }), o = (e.features.height - i) / t.length, a = 0;
        ...
        r.sankey = function () {
            ...
            function o(t) {
                ...
                function i() {
                    a.forEach(function (t) {
                        var e, n, r, s = 0, i = t.length;
                        for (t.sort(o), r = 0; r < i; ++r) e = t[r], n = s - e.y, n > 0 && (e.y += n), s = e.y + e.dy + d;
                        if (n = s - d - l[1], n > 0) for (s = e.y -= n, r = i - 2; r >= 0; --r) e = t[r], n = e.y + e.dy + d - s, n > 0 && (e.y -= n), s = e.y
                    })
                }
            ...
            return f.nodeWidth = function (t) {
                ...
                function t(t) {
                    var n = t.source.x + t.source.dx, s = t.target.x, i = r.interpolateNumber(n, s), o = i(e),
                        a = i(1 - e), u = t.source.y + t.sy + t.dy / 2, c = t.target.y + t.ty + t.dy / 2;
